...
import static com.metricstream.walkmod.utils.Util.BINARY_EQUALS_OPERATOR;
import static com.metricstream.walkmod.utils.Util.BINARY_NOT_EQUALS_OPERATOR;
import static com.metricstream.walkmod.utils.Util.UNARY_NOT_OPERATOR;
...
import com.metricstream.walkmod.audit.AuditData;
import com.metricstream.walkmod.audit.AuditInfo;
import com.metricstream.walkmod.audit.AuditLogger;
...
public class UseStringEquals extends EqualsAndNotEqualsHandler {
	...
	private static final String RULE_ID = "com.metricstream:walkmod.plugin:usestringequals";
	...
	protected Expression applyChanges(BinaryExpr e) {
		...
		if (expression != null) {
			doAuditLog(fileName, e.toString(), expression.toString());
		}
		return expression;
	}
	 ...
	 *            the new code
	 */
	private void doAuditLog(String fileName, String oldCode, String newCode) {
		AuditInfo auditInfo = new AuditInfo();
		auditInfo.setName(fileName);
		auditInfo.setOldCode(oldCode);
		auditInfo.setNewCode(newCode);
		AuditData auditData = AUDIT_LOGGER.getAuditData();
		auditData.setData(RULE_ID, auditInfo);
	}
